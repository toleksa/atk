...
#    path('model/<str:model>/page/<int:page>', views.model),
    ...
    path('search/<str:search>/', views.search, {'site': 'search'}),
    path('search/<str:search>/page/<int:page>/', views.search, {'site': 'search'}),
    ...
    path('monthlist/', views.monthlist),
    path('monthrank/', views.top, {'site': 'monthrank'}),
...
##    path('month/<int:vote>/<int:second>/', views.month),
    ...
    path('liked/', views.likedmodels),
    path('monthtop/', views.monthtop),
    path('bestscore/', views.bestscore),
